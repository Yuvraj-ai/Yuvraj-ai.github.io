document.addEventListener("DOMContentLoaded", function () {
  ...
  techPills.forEach((pill) => {
    ...
    if (pill.classList.contains("python")) {
    ...
    } else if (pill.classList.contains("java")) {
      icon.className = "fa-brands fa-java";
      textContent = " Java";
      pill.style.backgroundColor = "#cce4f6";
      pill.style.color = "#00599C";
    } else if (pill.classList.contains("langchain")) {
      icon.className = "fa-solid fa-face-smiling-hands";
      textContent = " LangChain";
      ...
      pill.style.color = "#295723ff";
    } else if (pill.classList.contains("FAISS")) {
      icon.className = "fa-brands fa-meta";
      textContent = " FAISS";
    ...
    } else if (pill.classList.contains("gemini")) {
    ...
    } else if (pill.classList.contains("jupyter")) {
